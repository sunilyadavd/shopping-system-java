...
<html lang="en">
  <head>
    ...
    <script src="../assets1/js/chart-master/Chart.js"></script>
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.jsp#">
                                    <span class="photo"><img alt="avatar" src="../assets1/img/ui-zac.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.jsp#">
                                    <span class="photo"><img alt="avatar" src="../assets1/img/ui-divya.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.jsp#">
                                    <span class="photo"><img alt="avatar" src="../assets1/img/ui-danro.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.jsp#">
                                    <span class="photo"><img alt="avatar" src="../assets1/img/ui-sherman.jpg"></span>
                                    <span class="subject">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="panels.jsp">Panels</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="../assets1/img/ui-zac.jpg" class="img-circle" width="50"></p>
								<p><b>Zac Snider</b></p>
									<div class="row">
										<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								<div id="profile-02">
									<div class="user">
										<img src="../assets1/img/friends/fr-06.jpg" class="img-circle" width="80">
										<h4>DJ SHERMAN</h4>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="product-panel-2 pn">
								...
								<img src="../assets1/img/product.jpg" width="200" alt="">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="weather-2 pn">
								...
								<div class="row centered">
									<img src="../assets1/img/ny.jpg" class="img-circle" width="120">			
								</div>
								<div class="row data">
									<div class="col-sm-6 col-xs-6 goleft">
										<h4><b>16 ºC</b></h4>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="panels.jsp#" class="go-top">
