...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets1/js/gritter/css/jquery.gritter.css" />
      ...
      *********************************************************************************************************************************************************** -->
      			...
      			<div class="col-lg-6 col-md-6 col-sm-12">
      				...
      				<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> Gritter Examples</h4>
							...
							<a id="remove-all" class="btn btn-danger  btn-sm" href="general.jsp#">Remove all</a>
      				</div><!-- /showback -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="general.jsp#" class="go-top">
